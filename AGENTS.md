...
- `check` currently enforces minimum unit discovery of 180 desktop and 341 shared test cases, with no JUnit XML failures or errors. Raise a floor when deliberately adding tests; do not lower it to hide a discovery regression.
