...
private constructor(
    ...
    fun saveQuery(query: SavedQuery) {
        ...
        lock.withLock {
            ...
            writeJsonList(savedPath, queries, SavedQuery.serializer())
        }
    }
    ...
    fun addHistory(entry: HistoryEntry) {
        ...
        lock.withLock {
            ...
            writeJsonList(historyPath, history, HistoryEntry.serializer())
        }
    }

    fun clearHistory() {
        lock.withLock { writeJsonList(historyPath, emptyList(), HistoryEntry.serializer()) }
    }
