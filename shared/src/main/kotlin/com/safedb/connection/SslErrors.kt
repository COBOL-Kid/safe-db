...
fun classifyConnectionError(
    ...
    if (
        ...
        return ConnectionErrorClassification(
            ConnectionErrorKind.HostnameMismatch,
    ...
    if (
        ...
        return ConnectionErrorClassification(
            ConnectionErrorKind.CertificateRequired,
            showTroubleshooting = true,
        )
    }
    ...
    if (
        ...
        return ConnectionErrorClassification(
            ConnectionErrorKind.UntrustedCa,
            showTroubleshooting = true,
        )
    }
    ...
    return ConnectionErrorClassification(
        ...
        showTroubleshooting =
            context.location == DatabaseLocation.Organization && context.remoteHost,
    )
}

data class ConnectionErrorContext(val location: DatabaseLocation?, val remoteHost: Boolean)
