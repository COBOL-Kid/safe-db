...
data class SecurityLabel(
    val tone: SecurityTone,
    val text: String,
)
...
data class DialectInfo(
    val value: com.safedb.model.Dialect,
    val label: String,
    val defaultPort: Int,
)

val DIALECTS: List<DialectInfo> = listOf(
...
fun securityLabelForMode(mode: TransportSecurityMode, host: String = ""): SecurityLabel =
    when (mode) {
        ...
        -> SecurityLabel(SecurityTone.Success, "Secure connection")
