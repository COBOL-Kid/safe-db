...
internal fun queryRunResult(result: QueryResult): QueryRunResult = QueryRunResult(
    result,
    QueryRiskEvaluation(
        staticAssessment = null,
        finalAssessment = null,
        planStatus = QueryPlanStatus.Disabled,
        decision = QueryRiskDecision("", RiskGateState.Allowed, QueryRiskGate.Disabled, null, emptyList()),
    ),
)
