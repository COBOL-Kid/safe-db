...
// Cumulative real UI states for the marketing site's hero clip. Each frame is an independent
// deterministic render; the website stitches the PNGs. Output:
// /tmp/safedb-preview/hero/frame-NN.png (dark, Control Blue). Frame NN applies the first NN build
// steps; the last frame runs the query.
